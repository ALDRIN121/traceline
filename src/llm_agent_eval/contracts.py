...
VersionKind = Literal["source", "knowledge", "evaluation", "dataset", "target", "connection", "dashboard", "evaluator", "model_profile", "model_selection", "judge_rubric"]
VERSION_KINDS = frozenset(("source", "knowledge", "evaluation", "dataset", "target", "connection", "dashboard", "evaluator", "model_profile", "model_selection", "judge_rubric"))
